...
class EditorialManagerTransferServiceForm(forms.Form):
    ...
    submission_partner_code = forms.CharField(
        required=False, help_text="Your organization's Submission Partner Code."
    )
    license_code = forms.CharField(
        required=False, help_text="The license code for your organization."
    )
    journal_code = forms.CharField(
        required=False, help_text="The code for the current journal."
    )


def validate_editorial_manager_metadata_id(value):
    """
...
class EditorialManagerTransferServiceSectionEditorForm(forms.Form):
    ...
    janeway_section_name = forms.CharField(
        required=True,
        max_length=200,
        label="Section Name",
    ...
    em_section_id = forms.CharField(
        required=False,
        max_length=64,
        label="Editorial Manager Section ID",
        validators=[validate_editorial_manager_metadata_id],
